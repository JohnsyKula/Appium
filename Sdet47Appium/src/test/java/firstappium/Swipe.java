...
public class Swipe {
	@Test
	public void swipegalary() throws MalformedURLException
	{
...
//	    	    "left", 10, "top", 30, "width", 20, "height", 30,
//	    	    "direction", "left",
//	    	    "percent", 0.75
//	    	));
	    ...
	    ((JavascriptExecutor) driver).executeScript("mobile: swipeGesture", ImmutableMap.of(
	    	    "elementId", ((RemoteWebElement) ele).getId(),"direction","left","percent",1.0
	    	));
	    System.out.println(driver.findElement(AppiumBy.xpath("//android.widget.ImageView[1]")).getAttribute("focusable"));
